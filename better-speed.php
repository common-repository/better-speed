...
function better_speed_show_settings() {
  ...
  //check for bad plugins - list based on https://wpengine.com/support/disallowed-plugins/
	...
	echo '  <style>#better-speed-tabs-recommend .better-speed-recommendation{width:100%;display:block;text-decoration:none}#better-speed-tabs-recommend .better-speed-recommendation img{margin-right:25px;margin-bottom:10px}</style>';
  ...
  echo '      <li><a href="#better-speed-tabs-instant">' . __('Instant Page', 'whysoslow') . '</a></li>';
	echo '      <li><a href="#better-speed-tabs-recommend">' . __('Recommendations', 'whysoslow') . '</a></li>';
  echo '    </ul>';
  ...
  echo '        <img src="' . plugins_url('images/shortpixel.png', __FILE__) . '" width="172px" height="67px" align="left">';
  echo '        <h3><u>' . __('ShortPixel Image Optimizer', 'whysoslow') . '</u> <small><em>(plugin)</em></small></h3>';
  echo '        <p>' . __('A freemium, easy to use, comprehensive, stable and frequently updated image compression plugin. It is an easy to use, lightweight, install-and-forget-about-it image optimization plugin that can compress all your past images and PDF documents with a single click.', 'whysoslow') . '</p>';
  echo '      </a>';
	echo '      <br>';
  echo '      <a class="better-speed-recommendation" href="https://shortpixel.com/wpspai/af/IJLMBK5514013" target="_blank">';
  echo '        <img src="' . plugins_url('images/shortpixel.png', __FILE__) . '" width="172px" height="67px" align="left">';
  echo '        <h3><u>' . __('ShortPixel Adaptive Images', 'whysoslow') . '</u> <small><em>(plugin)</em></small></h3>';
  echo '        <p>' . __('An easy to use plugin that can help you solve within minutes all your website’s image-related problems. Display properly sized, smartly cropped and optimized images on your website; Images are processed on the fly and served from their CDN, in the next-gen WebP & AVIF formats, if the browser supports it.', 'whysoslow') . '</p>';
  echo '      </a>';
	echo '      <br>';
  echo '      <a class="better-speed-recommendation" href="https://affiliate.k.io/go/betterspeed" target="_blank">';
  echo '        <img src="' . plugins_url('images/krystal.jpg', __FILE__) . '" width="172px" height="43px" align="left">';
  echo '        <h3><u>' . __('Krystal', 'whysoslow') . '</u> <small><em>(hosting)</em></small></h3>';
  echo '        <p>' . __('UK&apos;s best web hosting - expert hosting solutions since 2002. Over 19 years of experience have gone in to creating the perfect cloud hosting platform. WordPress hosting options to suit every budget and requirement, using 100% renewable electricity from sources like the sun, wind and sea.', 'whysoslow') . '</p>';
  echo '      </a>';
	echo '      <br>';
  echo '      <a class="better-speed-recommendation" href="https://www.siteground.com/index.htm?afcode=35f221d1fae43ce8aa828293f9cdf92f" target="_blank">';
  echo '        <img src="' . plugins_url('images/siteground.png', __FILE__) . '" width="172px" height="34px" align="left">';
  echo '        <h3><u>' . __('SiteGround', 'whysoslow') . '</u> <small><em>(hosting)</em></small></h3>';
  echo '        <p>' . __('Web hosting platform crafted for easy website management. Managed WordPress hosting that&apos; powerful, yet simple to use. Building and maintaining a WordPress site is easy with their thoughtfully designed tools.', 'whysoslow') . '</p>';
  echo '      </a>';
	echo '      <br>';
  echo '      <a class="better-speed-recommendation" href="https://shareasale.com/r.cfm?b=1343154&u=2391583&m=41388" target="_blank">';
  echo '        <img src="' . plugins_url('images/wpengine.png', __FILE__) . '" width="172px" height="43px" align="left">';
  echo '        <h3><u>' . __('WP Engine', 'whysoslow') . '</u> <small><em>(hosting)</em></small></h3>';
  echo '        <p>' . __('Managed WordPress hosting that grows with your business. Build or migrate with confidence on the fastest, most reliable managed WordPress hosting platform with award-winning, 24/7 support. Get 3 months <strong><em>free</em></strong> when you get an annual plan.', 'whysoslow') . '</p>';
  echo '      </a>';
	echo '      <br>';
  echo '      <a class="better-speed-recommendation" href="https://www.shaytoder.com/course/?campaign=betterspeed&ref=6" target="_blank">';
  echo '        <img src="' . plugins_url('images/shay-logo-3-2.png', __FILE__) . '" width="172px" height="43px" align="left">';
  echo '        <h3><u>' . __('Page Speed Optimization', 'whysoslow') . '</u> <small><em>(course)</em></small></h3>';
  echo '        <p>' . __('A practical online course that will teach you how to improve the speed of any WordPress site. Brought to you by the winner of 1st place in a worldwide WordPress Performance Contest - Shay Toder.', 'whysoslow') . '</p>';
  echo '      </a>';
  echo '      <br>';
  echo '      <a class="better-speed-recommendation" href="https://shareasale.com/r.cfm?b=1531222&u=2391583&m=96547" target="_blank">';
  echo '        <img src="' . plugins_url('images/wpbuffs.png', __FILE__) . '" width="172px" height="38px" align="left">';
  echo '        <h3><u>' . __('WordPress Speed Optimization', 'whysoslow') . '</u> <small><em>(service)</em></small></h3>';
  echo '        <p>' . __('WP Buffs specializes in speed optimization for WordPress sites of all types and sizes. Never worry about a slow load time causing your visitors to leave, or Google penalizing your site for poor technical performance again. Their speed optimization service aims to have your website loading in under two seconds and improving your Core Web Vitals.', 'whysoslow') . '</p>';
  echo '      </a>';
	echo '      <br>';
  echo '    </div>';
  echo '  </div>';
